<?php
	...
	/* This PHP file contains all the necessarily loading for all the pages */
	if (version_compare(PHP_VERSION, '5.3.7', '<')) {
		exit("You must run PHP on atleast version 5.3.7 to allow for password security dawg.");
